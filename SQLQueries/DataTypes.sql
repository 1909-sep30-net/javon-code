...
-- string/text
	...
	-- NVARCHAR(n) - variable length up to n, Unicode string - use unless with good reason
	-- we've got a variety of functions for strings
...
-- date/time
	...
	-- can extract parts of dates/times using functions like
		-- YEAR(), DATEPART()
